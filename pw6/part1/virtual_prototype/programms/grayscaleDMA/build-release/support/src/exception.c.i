# 0 "support/src/exception.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "support/src/exception.c"
...
# 3 "support/src/exception.c" 2


# 4 "support/src/exception.c"
__attribute__((weak)) void i_cache_error_handler() {
    puts("I$ error!");
}

__attribute__((weak)) void d_cache_error_handler() {
    puts("D$ error!");
}

__attribute__((weak)) void illegal_instruction_handler() {
    puts("????");
}

__attribute__((weak)) void external_interrupt_handler() {
    puts("ping");
}

__attribute__((weak)) void system_call_handler() {
    puts("Syscall");
}
