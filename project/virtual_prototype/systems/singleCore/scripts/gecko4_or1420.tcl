...
set_location_assignment PIN_AA8 -to dipSwitch[0]
set_location_assignment PIN_AB8 -to dipSwitch[1]
set_location_assignment PIN_AA9 -to dipSwitch[2]
set_location_assignment PIN_AB9 -to dipSwitch[3]
set_location_assignment PIN_AA10 -to dipSwitch[4]
set_location_assignment PIN_AB10 -to dipSwitch[5]
set_location_assignment PIN_V10 -to dipSwitch[6]
set_location_assignment PIN_V11 -to dipSwitch[7]
set_instance_assignment -name WEAK_PULL_UP_RESISTOR ON -to dipSwitch[0]
set_instance_assignment -name WEAK_PULL_UP_RESISTOR ON -to dipSwitch[1]
set_instance_assignment -name WEAK_PULL_UP_RESISTOR ON -to dipSwitch[2]
set_instance_assignment -name WEAK_PULL_UP_RESISTOR ON -to dipSwitch[3]
set_instance_assignment -name WEAK_PULL_UP_RESISTOR ON -to dipSwitch[4]
set_instance_assignment -name WEAK_PULL_UP_RESISTOR ON -to dipSwitch[5]
set_instance_assignment -name WEAK_PULL_UP_RESISTOR ON -to dipSwitch[6]
set_instance_assignment -name WEAK_PULL_UP_RESISTOR ON -to dipSwitch[7]

set_location_assignment PIN_U11 -to sevenSegments[0]
set_location_assignment PIN_G18 -to sevenSegments[1]
set_location_assignment PIN_M8 -to sevenSegments[2]
set_location_assignment PIN_L6 -to sevenSegments[3]
set_location_assignment PIN_W10 -to sevenSegments[4]
set_location_assignment PIN_U10 -to sevenSegments[5]
set_location_assignment PIN_V9 -to sevenSegments[6]
set_location_assignment PIN_L7 -to sevenSegments[7]

set_location_assignment PIN_U9 -to sevenSegments[8]
set_location_assignment PIN_W8 -to sevenSegments[9]
set_location_assignment PIN_V8 -to sevenSegments[10]
set_location_assignment PIN_Y4 -to sevenSegments[11]
set_location_assignment PIN_T11 -to sevenSegments[12]
set_location_assignment PIN_Y10 -to sevenSegments[13]
set_location_assignment PIN_T10 -to sevenSegments[14]
set_location_assignment PIN_W7 -to sevenSegments[15]

set_location_assignment PIN_K19 -to sevenSegments[16]
set_location_assignment PIN_T9 -to sevenSegments[17]
set_location_assignment PIN_E14 -to sevenSegments[18]
set_location_assignment PIN_T5 -to sevenSegments[19]
set_location_assignment PIN_T7 -to sevenSegments[20]
set_location_assignment PIN_R7 -to sevenSegments[21]
